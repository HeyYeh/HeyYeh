    ...
    trebleGMajor: {
        music: function () {
            ...
            if (hintstoggle == true) {
                ...
                accidental2 = new VF.StaveNote({
                    keys: ["f/5"],
                    duration: "h"
                }).addAccidental(
                    0,
                    new VF.Accidental("#"));
                accidental3 = new VF.StaveNote({
                    keys: ["f/5"],
                    duration: "h"
                }).addAccidental(
                    0,
                    new VF.Accidental("#"));
                accidental4 = new VF.StaveNote({
                    keys: ["f/4"],
                    duration: "h"
                }).addAccidental(
                    0,
    ...
    trebleDMajor: {
        music: function () {
            ...
            if (hintstoggle == true) {
                ...
                accidental6 = new VF.StaveNote({
                    keys: ["f/5"],
                    duration: "h"
                }).addAccidental(
                    0,
                    new VF.Accidental("#"));
                accidental7 = new VF.StaveNote({
                    keys: ["c/5"],
                    duration: "h"
                }).addAccidental(
                    0,
                    new VF.Accidental("#"));
                accidental8 = new VF.StaveNote({
                    keys: ["f/4"],
                    duration: "h"
                }).addAccidental(
                    0,
...
$(document).ready(function () {
    ...
    $("#clef1").click(function () {
        if (clefButtons == 1) {
            ...
            clefButtons = 1;
            $.each(AltoArray, function (index, value) {
                disable(value);
            })
            $.each(BassArray, function (index, value) {
                disable(value);
            })
            $.each(PianoArray, function (index, value) {
                disable(value);
            })
            $.each(TrebleArray, function (index, value) {
                enable(value);
            })
            $(".test").html(cache);
        }
